    ...
    return (
        <div style={{ position: 'absolute', width: '100%', top: 0, left: 0, zIndex: 50 }}>
            <nav className='navbar px-5 py-4 flex justify-between items-center'
                ...
                <div className='d-flex align-items-center gap-2'>
                    <img src={assets.mark} alt='Logo' className='w-8 h-8' style={{ filter: 'brightness(0) invert(1)' }} />
                    <span className='font-bold text-xl text-white'>Authio</span>
                </div>
                ...
                {userData ? (
                    ...
                    <div className="btn btn-light rounded-pill px-3" onClick={() => navigate("/login")}>
                        Login <i className='bi bi-arrow-right ms-2'></i>
                    </div>
                )}
            </nav>
