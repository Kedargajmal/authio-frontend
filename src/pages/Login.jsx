    ...
    return (
        <div className='position-relative min-vh-100 d-flex justify-content-center align-items-center overflow-hidden'
            ...
            <div style={{
                ...
                background: 'radial-gradient(circle, rgba(22, 163, 74, 0.40) 0%, rgba(0, 0, 0, 0) 70%)',
                filter: 'blur(80px)', zIndex: 0, pointerEvents: 'none',
                animation: 'pulse-out 12s ease-in-out infinite reverse'
            }}></div>
            ...
            <div className='p-4 border border-secondary border-opacity-25'
                style={{
                    ...
                    backgroundColor: "rgba(255, 255, 255, 0.03)",
                    backdropFilter: "blur(15px)", zIndex: 1,
                    boxShadow: '0 8px 32px rgba(0, 0, 0, 0.37)'
                }}>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    {!isCreatingAccount && (
                        <div className='d-flex justify-content-end mb-4'>
                            <Link to="/reset-password" style={{ color: '#4ade80', fontSize: '13px' }} className='text-decoration-none'>
                                Forgot Password?
                            </Link>
                        </div>
                    )}
                    ...
                    <button type='submit'
                        className='btn btn-light w-100 fw-bold rounded-pill py-2'
                        disabled={loading}>
                        {loading ? "Processing..." : isCreatingAccount ? "Sign Up" : "Login"}
                    </button>
                </form>
